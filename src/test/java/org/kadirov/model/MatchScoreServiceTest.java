...
class MatchScoreServiceTest {
    ...
    private MatchScoreService underTest;

    private PlayerScoreEntity firstPlayer;
    private PlayerScoreEntity secondPlayer;

    @BeforeEach
    void setUp() {
        firstPlayer = mock(PlayerScoreEntity.class);
        secondPlayer = mock(PlayerScoreEntity.class);
        underTest = new MatchScoreServiceImpl();
    }
